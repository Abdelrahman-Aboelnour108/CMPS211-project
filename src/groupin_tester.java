...
public class groupin_tester {
    ...
    private static void testConcurrentEdits() {
        ...
        java.util.List<CharNode> q1 = new java.util.ArrayList<>();
        ...
        java.util.List<CharNode> q2 = new java.util.ArrayList<>();
    ...
    private static void MultiUserEdits(Scanner scanner) {
        ...
        while (true) {
            ...
            java.util.List<CharNode> turnQ1 = new java.util.ArrayList<>();
            ...
            java.util.List<CharNode> turnQ2 = new java.util.ArrayList<>();
